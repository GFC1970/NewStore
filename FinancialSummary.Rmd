...
h3 {font-weight:700lcolor:#4682B4}
...
products <- str_c(unique(data_tbl$product_name), collapse = ", ")
categories <- str_c(unique(data_tbl$product_category), collapse = ", ")
sizes <- str_c(unique(data_tbl$product_size), collapse = ", ")
colours <- str_c(unique(data_tbl$product_colour), collapse = ", ")
```
